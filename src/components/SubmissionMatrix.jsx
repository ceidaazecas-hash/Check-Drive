...
const SOLID_CATEGORY_THEMES = [
  { name: 'purple', solidBg: 'bg-[#805ad5]', hoverBg: 'hover:bg-[#6b46c1]', tileContainer: 'bg-purple-50/50' },
  { name: 'pink', solidBg: 'bg-[#d53f8c]', hoverBg: 'hover:bg-[#b83280]', tileContainer: 'bg-pink-50/50' },
  { name: 'teal', solidBg: 'bg-[#319795]', hoverBg: 'hover:bg-[#234e52]', tileContainer: 'bg-teal-50/50' },
  { name: 'orange', solidBg: 'bg-[#dd6b20]', hoverBg: 'hover:bg-[#c05621]', tileContainer: 'bg-orange-50/50' },
  { name: 'indigo', solidBg: 'bg-[#4c51bf]', hoverBg: 'hover:bg-[#3c366b]', tileContainer: 'bg-indigo-50/50' },
  { name: 'cyan', solidBg: 'bg-[#008080]', hoverBg: 'hover:bg-[#005555]', tileContainer: 'bg-cyan-50/50' }
];
...
export default function SubmissionMatrix({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 w-full border-0">
      
      {/* Top Header & View Mode Switcher */}
      <div className="p-4 sm:p-5 flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-gray-50/70 border-0">
        <div>
          <h3 className="text-base font-black text-gray-900">Submission Audit Matrix</h3>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="relative">
            <input
              ...
              className="px-3.5 py-1.5 bg-gray-100 rounded-xl text-xs text-gray-900 focus:bg-white focus:ring-2 focus:ring-google-blue min-w-[170px] border-0 font-medium"
            />
          </div>
          ...
          <select
            ...
            className="bg-gray-100 rounded-xl px-3 py-1.5 text-xs text-gray-700 font-bold focus:ring-2 focus:ring-google-blue border-0 cursor-pointer"
          >
          ...
          {layoutMode === 'table' && (
            <div className="flex items-center bg-gray-200/80 p-0.5 rounded-xl text-xs font-bold border-0 shadow-2xs">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all border-0 ${tableDetailMode === 'compact' ? 'bg-white text-google-blue shadow-2xs font-black' : 'text-gray-600 hover:text-gray-900'}`}
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all border-0 ${tableDetailMode === 'standard' ? 'bg-white text-google-blue shadow-2xs font-black' : 'text-gray-600 hover:text-gray-900'}`}
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg transition-all border-0 ${tableDetailMode === 'detailed' ? 'bg-white text-google-blue shadow-2xs font-black' : 'text-gray-600 hover:text-gray-900'}`}
          ...
          <div className="flex items-center bg-gray-200/80 p-0.5 rounded-xl text-xs font-bold border-0 shadow-2xs">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all border-0 ${
                layoutMode === 'table' ? 'bg-white text-google-blue shadow-xs font-black' : 'text-gray-600 hover:text-gray-900'
              }`}
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all border-0 ${
                layoutMode === 'heatmap' ? 'bg-white text-google-blue shadow-xs font-black' : 'text-gray-600 hover:text-gray-900'
              }`}
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all border-0 ${
                layoutMode === 'cards' ? 'bg-white text-google-blue shadow-xs font-black' : 'text-gray-600 hover:text-gray-900'
              }`}
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-[#48bb78] hover:bg-[#38a169] text-white rounded-xl text-xs font-black shadow-xs transition-all border-0"
      ...
      {groups.length > 1 && (
        <div className="px-4 py-3 bg-gray-50/90 flex items-center justify-center gap-2 overflow-x-auto text-xs border-0">
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl font-black transition-all text-xs shrink-0 border-0 shadow-2xs text-center justify-center ${
          ...
          {groups.map((g, idx) => {
            ...
            return (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl font-black transition-all text-xs flex items-center justify-center gap-1.5 shrink-0 border-0 shadow-2xs text-white text-center ${theme.solidBg} ${theme.hoverBg} ${
                  isSelected
                    ? 'scale-105 shadow-md'
        ...
        <div className="overflow-x-auto max-h-[75vh]">
          <table className="w-full text-center border-collapse min-w-[950px]">
            <thead className="sticky top-0 z-20">
              ...
              <tr className="text-xs font-black tracking-wide uppercase">
                <th
                  rowSpan={2}
                  className="py-3.5 px-4 sticky left-0 bg-gray-100 z-30 w-64 align-middle text-gray-900 text-center"
                >
                  Student Name
                </th>
                ...
                {visibleGroups.map((group, gIdx) => {
                  ...
                  return (
                    <th
                      ...
                      className={`py-2.5 px-3 text-center ${theme.solidBg} text-white font-black tracking-wider text-[11px]`}
                    >
                ...
                <th rowSpan={2} className="py-3 px-3 text-center min-w-[85px] bg-[#48bb78] text-white font-black align-middle">
                  Submitted
                </th>
              ...
              <tr className="bg-gray-50 text-[10px] font-black text-gray-600 uppercase tracking-wider text-center">
                {visibleFlattenedCols.map(col => {
                  const rangeObj = rangeLookup[col.subfolder] || rangeLookup[col.category];
                  return (
                    <th key={col.key} className="py-2 px-2 text-center min-w-[130px]">
              ...
              {filteredRows.map((row, idx) => {
                ...
                return (
                  <tr key={row.studentName || idx} className={`transition-colors ${idx % 2 === 0 ? 'bg-white hover:bg-blue-50/30' : 'bg-gray-50/40 hover:bg-blue-50/30'}`}>
                    ...
                    <td className={`py-3 px-4 font-bold text-gray-900 sticky left-0 z-10 ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                      <div className="flex items-center justify-center space-x-2.5">
                        <div className="w-7 h-7 rounded-full bg-blue-100 text-google-blue font-bold text-[11px] flex items-center justify-center shrink-0">
                    ...
                    {visibleFlattenedCols.map(col => {
                      ...
                      if (!cellData) {
                        return (
                          <td key={col.key} className="py-3 px-2 text-center text-gray-300">
                      ...
                      if (cellData.isFolderEmpty) {
                        return (
                          <td key={col.key} className="py-2.5 px-2 text-center bg-rose-50/30">
                            <span
                              className="inline-flex items-center justify-center px-2.5 py-1 rounded-lg text-[10px] font-black bg-[#f56565] text-white border-0 shadow-2xs text-center"
                        ...
                        >
                          <div className="flex flex-col items-center justify-center py-1 text-center">
                            ...
                            {isLate ? (
                              ...
                              <span
                                className="inline-flex items-center justify-center px-2.5 py-0.5 rounded-lg text-[10px] font-black bg-[#48bb78] text-white border-0 shadow-2xs text-center"
                            ...
                            {tableDetailMode === 'detailed' && firstFile?.name && (
                              <a
                                ...
                                className="text-[9.5px] font-bold text-google-blue hover:text-blue-800 hover:underline max-w-[125px] block mt-1.5 shadow-2xs bg-blue-50 px-1.5 py-0.5 rounded overflow-hidden text-center justify-center border-0"
                    ...
                    <td className="py-3 px-3 text-center font-black text-[#48bb78] bg-emerald-50/20">
                      {row.submittedCount}
                    </td>

                    {/* Empty Folders Count */}
                    <td className="py-3 px-3 text-center font-black text-[#f56565] bg-rose-50/20">
                      {row.emptyCount}
                    </td>
      ...
      {layoutMode === 'heatmap' && (
        <div className="w-full divide-y divide-gray-100">
          ...
          <div className="bg-gray-100 text-xs select-none">
            
            {/* Tier 1: Main Parent Folder Category Bar */}
            <div className="flex items-center justify-center p-2 px-4 gap-2">
              <span className="w-52 shrink-0 font-black text-gray-700 text-xs uppercase tracking-wider text-center">
              ...
              <span className="w-20 text-center shrink-0 font-black text-gray-700 text-xs uppercase tracking-wider">
                Progress
              </span>
            </div>
            ...
            <div className="flex items-center justify-center p-1.5 px-4 gap-2 text-[10px] font-bold text-gray-500 bg-gray-50">
              <div className="w-52 shrink-0 flex items-center justify-center gap-1.5">
                <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded bg-[#48bb78] text-white font-black text-[9px] shadow-2xs text-center">
                  On Time
                </span>
                <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded bg-[#f6ad55] text-white font-black text-[9px] shadow-2xs text-center">
                  Late
                </span>
                <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded bg-[#f56565] text-white font-black text-[9px] shadow-2xs text-center">
                  Missing
                </span>
              </div>
                ...
                {visibleGroups.map((group, gIdx) => (
                  <div key={group.categoryName} style={{ flex: group.columns.length }} className="flex gap-1 justify-center">
                    {group.columns.map(col => (
                      <div
                        key={col.key}
                        className="flex-1 min-w-[22px] max-w-[42px] text-center running-tile-container text-[9px] text-gray-600 font-black"
              ...
              <span className="w-20 text-center shrink-0 text-gray-400 font-bold">Rate</span>
            </div>
                ...
                >
                  ...
                  <div className="w-52 shrink-0 flex items-center justify-center space-x-2.5 overflow-hidden">
                    ...
                    <div className="flex flex-col overflow-hidden max-w-[160px] text-center">
                      ...
                      <span className="text-[10px] text-gray-400 text-center font-bold">
                    ...
                    {visibleGroups.map((group, gIdx) => {
                      ...
                      return (
                        <div
                          key={group.categoryName}
                          style={{ flex: group.columns.length }}
                          className={`p-1 rounded-xl ${theme.tileContainer} flex gap-1 justify-center border-0`}
                        >
                          {group.columns.map(col => {
                            const cellData = row.submissions[col.key];
                            const deadlineIso = weekDeadlines[col.subfolder] || weekDeadlines[col.category];
                            ...
                            if (!cellData) {
                              return (
                                <div
                                  key={col.key}
                                  className="flex-1 min-w-[20px] max-w-[40px] h-8 rounded-lg bg-gray-200 flex items-center justify-center text-[10px] text-gray-400 font-black text-center border-0"
                            ...
                            if (cellData.isFolderEmpty) {
                              return (
                                <button
                                  ...
                                  className="flex-1 min-w-[20px] max-w-[40px] h-8 rounded-lg bg-[#f56565] hover:bg-[#e53e3e] border-0 flex flex-col items-center justify-center text-white font-black text-[10px] transition-all shadow-2xs cursor-pointer hover:scale-105 running-tile-container text-center"
                                  title={`Main Folder: ${col.category} | Subfolder: ${col.subfolder} | Status: EMPTY (0 files uploaded)`}
                                >
                                  ...
                                  <div className="running-tile-container max-w-full px-0.5 text-center">
                                    <span className="text-[7.5px] text-white leading-none running-tile-text font-black text-center">
                                      {col.subfolder.replace(/Week\s+/i, 'W')}
                                    </span>
                                  </div>
                                </button>
                            ...
                            return (
                              <button
                                key={col.key}
                                onClick={() => setSelectedCell({ student: cleanName, category: col.category, subfolder: col.subfolder, cellData, isLate, statusInfo })}
                                className={`flex-1 min-w-[20px] max-w-[40px] h-8 rounded-lg flex flex-col items-center justify-center font-black text-[10px] transition-all shadow-2xs border-0 cursor-pointer hover:scale-105 running-tile-container text-center ${
                                  isLate
                  ...
                  <div className="w-20 shrink-0 text-center">
                    <div className="flex flex-col items-center justify-center text-center">
                      <span className={`text-xs font-black ${pct === 100 ? 'text-[#48bb78]' : pct >= 75 ? 'text-blue-700' : 'text-[#f6ad55]'}`}>
                        {pct}%
                      </span>
          ...
          {filteredRows.map((row, idx) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between border-0"
              >
                <div>
                  {/* Card Header with Running Text on Hover */}
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-2.5 overflow-hidden">
                      <div className="w-9 h-9 rounded-xl bg-blue-100 text-google-blue font-black text-xs flex items-center justify-center shrink-0">
                        {getInitials(row.studentName) || 'ST'}
                      </div>
                    ...
                    <span className={`px-2 py-0.5 rounded-lg text-[11px] font-black shrink-0 border-0 ${
                      pct === 100
                  ...
                  <div className="space-y-2">
                    {visibleGroups.map((group, gIdx) => {
                      const theme = SOLID_CATEGORY_THEMES[gIdx % SOLID_CATEGORY_THEMES.length];
                      return (
                        <div key={group.categoryName} className="p-2.5 rounded-xl bg-gray-50 border-0">
                          <div className="text-[10px] font-black text-white uppercase tracking-wider mb-1.5 flex items-center justify-center">
                          ...
                          <div className="flex flex-wrap gap-1.5 justify-center">
                            {group.columns.map(col => {
                              ...
                              if (!cellData) {
                                return (
                                  <span key={col.key} className="px-2 py-0.5 rounded bg-gray-200 text-gray-400 text-[10px] font-black text-center">
                                    {col.subfolder}: —
                                  </span>
                                );
                              }
                              ...
                              if (cellData.isFolderEmpty) {
                                return (
                                  <button
                                    key={col.key}
                                    onClick={() => setSelectedCell({ student: cleanName, category: col.category, subfolder: col.subfolder, cellData, isLate: false, statusInfo: { label: 'Empty' } })}
                                    className="px-2 py-0.5 rounded bg-[#f56565] hover:bg-[#e53e3e] text-white border-0 text-[10px] font-black flex items-center justify-center gap-1 shadow-2xs text-center"
                                  >
                              ...
                              return (
                                <button
                                  key={col.key}
                                  onClick={() => setSelectedCell({ student: cleanName, category: col.category, subfolder: col.subfolder, cellData, isLate, statusInfo })}
                                  className={`px-2 py-0.5 rounded text-[10px] font-black flex items-center justify-center gap-1 shadow-2xs border-0 text-center ${
                                    isLate
                                      ? 'bg-[#f6ad55] hover:bg-[#ed8936] text-white'
                                      : 'bg-[#48bb78] hover:bg-[#38a169] text-white'
                                  }`}
                ...
                {/* Card Footer Summary */}
                <div className="mt-3 pt-2 flex items-center justify-between text-[11px] text-gray-500 font-black text-center">
                  <span className="text-[#48bb78] font-black">{submittedCount} Submitted</span>
                  <span className="text-[#f56565] font-black">{emptyCount} Missing</span>
                </div>
      ...
      {/* Footer Legend (Clean, Centered, No Emojis, Solid) */}
      <div className="p-3.5 bg-gray-50 text-xs text-gray-600 flex flex-wrap items-center justify-center gap-6 text-center border-0">
      ...
      {selectedCell && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded-3xl p-6 max-w-md w-full relative animate-in fade-in zoom-in duration-150 text-center border-0 shadow-2xl">
            
            <button
              onClick={() => setSelectedCell(null)}
              className="absolute top-4 right-4 p-1 text-gray-400 hover:text-gray-700 rounded-lg hover:bg-gray-100 font-bold border-0"
            >
              &times;
            </button>

            <div className="flex flex-col items-center justify-center space-y-2 mb-3 text-center">
              <div className={`px-4 py-1.5 rounded-xl font-black text-sm text-white border-0 ${
                selectedCell.isLate
                  ? 'bg-[#f6ad55]'
              ...
              <div>
                <h4 className="text-sm font-black text-gray-900">{selectedCell.student}</h4>
                <div className="text-xs text-gray-500 font-bold mt-0.5 text-center">
                  <span className="text-gray-700">{selectedCell.category}</span>
                  {' > '}
                  <span className="text-google-blue font-black">{selectedCell.subfolder}</span>
                </div>
              </div>
            </div>

            <div className="bg-gray-50 rounded-2xl p-4 mb-4 space-y-2 text-xs text-center border-0">
              <div className="space-y-2">
                <span className="text-gray-500 block font-black text-center">Uploaded Files ({selectedCell.cellData.files.length}):</span>
                {selectedCell.cellData.files.length === 0 ? (
                  ...
                  selectedCell.cellData.files.map((file, i) => (
                    <div key={i} className="bg-white p-3 rounded-xl flex items-center justify-between gap-2 shadow-2xs text-left border-0">
                      <div className="overflow-hidden">
                        <div className="font-bold text-gray-900 truncate" title={file.name}>
                          {file.name}
                        </div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-3 py-1 bg-google-blue hover:bg-google-hover text-white rounded-lg text-[11px] font-black shrink-0 shadow-2xs border-0"
                      >
                        Open
                      </a>
                    </div>
            ...
            <button
              onClick={() => setSelectedCell(null)}
              className="w-full py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-xs font-black border-0"
            >
              Close Preview
            </button>
